...
public class ResolverRadialChaikin implements SwipeResolver {
	...
	public static float simplifyTolerance = .01f;
	...
	public static void smooth(Array<Vector2> input, Array<Vector2> output) {
		...
		for (int i=0; i<input.size-1; i++) {
			...
			/*Vector2 Q = new Vector2(0.90f * p0.x + 0.10f * p1.x, 0.90f * p0.y + 0.10f * p1.y);
			Vector2 R = new Vector2(0.10f * p0.x + 0.90f * p1.x, 0.10f * p0.y + 0.90f * p1.y);
*/
	        output.add(Q);
	        output.add(R);
		}
