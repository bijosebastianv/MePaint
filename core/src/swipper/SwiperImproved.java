...
public class SwiperImproved extends ApplicationAdapter implements InputProcessor {
...
stage=new Stage(new ScreenViewport());
       ...
       // stage.addActor(new Sprite(tex));
		...
		tr=  new TextureRegion(SwipeTriStrip.buffer.getColorBufferTexture());
		tr.flip(false, true);
	}
